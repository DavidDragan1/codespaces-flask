...
system_context = (
    ...
    "4. Return the most appropriate area or group of organs from this list \"ankles, digestive system, head, heart, neck/throat, elbows, wrists, hands, knees, hips, reproductive system, spine, shoulders, lungs, liver, kidneys, feet, or whole body/skin\" based on the symptoms described in chief complaint.\n\n"
